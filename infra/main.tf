...
# Provisions multiple EC2 instances for Netflix clone infrastructure
# Creates Jenkins server, monitoring server, Kubernetes master and worker nodes
# Each instance gets Ubuntu AMI, appropriate instance type, and SSM role attached
